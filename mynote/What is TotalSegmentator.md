...
- Github地址：https://link.zhihu.com/?target=https%3A//github.com/wasserth/TotalSegmentator
- 训练数据下载
...
![TotalSegmentator示意图](mynote/image/TotalSegmentator_diagram.png)
...
![子任务示意图](mynote/image/TotalSegmentator_Subtask_diagram.png)
...
![资源需求示意图](mynote/image/TotalSegmentator_Resource_demand_diagram.png)
